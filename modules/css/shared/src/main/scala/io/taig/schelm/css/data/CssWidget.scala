...
final case class CssWidget[+Event, -Context](
    widget: Widget[Context, CssNode[Event, CssWidget[Event, Context]]]
) extends AnyVal

object CssWidget {
  def toStylesheetHtml[Event, Context](widget: CssWidget[Event, Context], context: Context): CssHtml[Event] =
    widget.widget match {
      case widget: Widget.Patch[Context, CssNode[Event, CssWidget[Event, Context]]] =>
