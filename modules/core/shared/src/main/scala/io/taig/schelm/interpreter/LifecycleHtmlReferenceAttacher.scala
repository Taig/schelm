...
//      attacher: Attacher[F, HtmlReference[Node, Element, Text], Element]
//  ): Attacher[F, LifecycleHtmlReference[F, Node, Element, Text], Element] =
//    new Attacher[F, LifecycleHtmlReference[F, Node, Element, Text], Element] {
//      override def attach(html: LifecycleHtmlReference[F, Node, Element, Text]): F[Element] =
//        attacher.attach(html.toHtmlReference) <* notify(html)
//
//      def notify(html: LifecycleHtmlReference[F, Node, Element, Text]): F[Unit] =
...
//      dom: Dom[F]
//  )(parent: dom.Element): Attacher[F, LifecycleHtmlReference[F, dom.Node, dom.Element, dom.Text], dom.Element] =
