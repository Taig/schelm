...
//  ): Renderer[F, Component[A], NodeReference[dom.Element, dom.Text, B]] =
//    new Renderer[F, Component[A], NodeReference[dom.Element, dom.Text, B]] {
//      override def render(component: Component[A]): F[NodeReference[dom.Element, dom.Text, B]] =
//        component match {
