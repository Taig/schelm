...
//        case (current: Node.Fragment[Event, Html[Event]], next: Node.Fragment[Event, Html[Event]]) =>
...
//
//    def fragment(
//        current: Node.Fragment[Event, Html[Event]],
//        next: Node.Fragment[Event, Html[Event]]
//    ): Option[HtmlDiff[Event]] =
