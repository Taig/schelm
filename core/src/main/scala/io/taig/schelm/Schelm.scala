...
final class Schelm[F[_], Event, Component, Reference, Diff](
    dom: Dom[F, Event],
    manager: EventManager[F, Event],
    renderer: Renderer[F, Component, Reference],
    attacher: Attacher[F, Reference],
...
object Schelm {
  def apply[F[_]: ConcurrentEffect, Event, Component, Reference, Diff](
      dom: Dom[F, Event],
      manager: EventManager[F, Event],
      renderer: Renderer[F, Component, Reference],
      attacher: Attacher[F, Reference],
      differ: Differ[Component, Diff],
      patcher: Patcher[F, Reference, Diff]
  ): Schelm[F, Event, Component, Reference, Diff] =
    new Schelm[F, Event, Component, Reference, Diff](
      dom,
      manager,
      renderer,
      attacher,
